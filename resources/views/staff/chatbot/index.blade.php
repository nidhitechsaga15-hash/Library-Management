...
<div class="chatbot-container" style="height: calc(100vh - 120px); margin: 0; padding: 0;">
    <div class="chatbot-header">
        ...
        <p>Ask me anything about library management</p>
    </div>

    <div class="chatbot-messages" id="chatbotMessages">
        <div class="welcome-message">
            <h5>👋 Welcome to Library Chatbot!</h5>
            <p>I'm here to help you with library management tasks.</p>
            <div class="feature-list">
                <h6>I can help you with:</h6>
                <ul>
                    <li>📖 Issue/Return process guidance</li>
                    <li>💰 Fine calculation questions</li>
                    <li>📋 Reservation approvals workflow</li>
                    <li>💻 Digital library / e-resource queries</li>
                    <li>❓ Quick FAQs for daily tasks</li>
                </ul>
            </div>
    ...
    <div class="chatbot-input-area">
        <div class="quick-actions mb-3">
            ...
            <button class="quick-action-btn" onclick="sendQuickMessage('How to calculate fine?')">
                💰 Fine Calculation
            </button>
            <button class="quick-action-btn" onclick="sendQuickMessage('Reservation workflow')">
                📋 Reservations
            </button>
            <button class="quick-action-btn" onclick="sendQuickMessage('Daily tasks')">
                📋 Daily Tasks
            </button>
            <button class="quick-action-btn" onclick="sendQuickMessage('Book requests')">
                📚 Book Requests
            </button>
            <button class="quick-action-btn" onclick="sendQuickMessage('E-resources')">
                💻 E-Resources
            </button>
        </div>
...
<script>
    ...
    function sendMessage() {
        ...
        // Send request
        fetch('{{ route("staff.chatbot.query") }}', {
            method: 'POST',
            headers: {
