...
@section('title', 'Borrows Management')
@section('page-title', 'Borrows Management')

@section('content')
<style>
    .borrows-table-wrapper {
        overflow-x: auto;
        overflow-y: visible;
        width: 100%;
        -webkit-overflow-scrolling: touch;
    }
    .borrows-table-wrapper .table {
        min-width: 1000px;
        width: 100% !important;
    }
    .card-modern {
...
<div class="card-modern">
    <div class="card-header-modern">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.borrows.overdue') }}" class="btn btn-danger">
    ...
    <div class="card-body p-4">
        <div class="row">
            <div class="col-12">
                <div class="table-responsive borrows-table-wrapper">
...
<script>
    $(document).ready(function() {
        ...
        // Initialize DataTables with proper scrollX configuration
