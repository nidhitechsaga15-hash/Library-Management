...
<div class="card-modern">
    <div class="card-header-modern">
        ...
        <div>
            <a href="{{ route('admin.library-cards.print', $libraryCard) }}" class="btn btn-secondary" target="_blank">
                <i class="fas fa-print me-2"></i>Print Card
            </a>
            <a href="{{ route('admin.library-cards.index') }}" class="btn btn-secondary">
                        ...
                        <div class="row g-3">
                            @if(!$libraryCard->isBlocked())
                                <div class="col-12 col-md-4">
                                    <form action="{{ route('admin.library-cards.block', $libraryCard) }}" method="POST">
                                        @csrf
                            ...
                            @else
                                <div class="col-12 col-md-4">
                                    <form action="{{ route('admin.library-cards.unblock', $libraryCard) }}" method="POST">
                                        @csrf
                            ...
                            <div class="col-12 col-md-4">
                                <a href="{{ route('admin.library-cards.print', $libraryCard) }}" class="btn btn-primary w-100" target="_blank">
                                    <i class="fas fa-print me-2"></i>Print Card
                                </a>
                            </div>
                        </div>
...
<div class="modal fade" id="renewModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.library-cards.renew', $libraryCard) }}" method="POST">
                @csrf
