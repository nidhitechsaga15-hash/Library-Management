...
<div class="card-modern">
    <div class="card-header-modern">
        ...
        <a href="{{ route('admin.library-cards.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.library-cards.show', $card) }}" class="btn btn-sm btn-info" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.library-cards.print', $card) }}" class="btn btn-sm btn-secondary" title="Print" target="_blank">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        @if(!$card->isBlocked())
                                            <form action="{{ route('admin.library-cards.block', $card) }}" method="POST" class="d-inline">
                                                @csrf
                                        ...
                                        @else
                                            <form action="{{ route('admin.library-cards.unblock', $card) }}" method="POST" class="d-inline">
                                                @csrf
