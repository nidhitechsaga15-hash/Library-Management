...
<head>
    ...
    <style>
        * {
        ...
        .stat-icon.warning { background: linear-gradient(45deg, #f6e05e, #fbd38d); }
        .stat-icon.success { background: linear-gradient(45deg, #48bb78, #68d391); }
        .stat-icon.danger { background: linear-gradient(45deg, #f56565, #ef4444); }
        .stat-icon.info { background: linear-gradient(45deg, #4299e1, #63b3ed); }
        .stat-icon.secondary { background: linear-gradient(45deg, #a0aec0, #cbd5e0); }
        .table-modern {
            width: 100%;
            margin-bottom: 0;
        ...
        /* Table Column Widths - 12 Column Grid Distribution */
        .table-modern th:nth-child(1), .table-modern td:nth-child(1) { width: 5%; min-width: 50px; } /* # */
        .table-modern th:nth-child(2), .table-modern td:nth-child(2) { width: 8%; min-width: 80px; } /* Image */
        .table-modern th:nth-child(3), .table-modern td:nth-child(3) { width: 10%; min-width: 100px; } /* ISBN */
        .table-modern th:nth-child(4), .table-modern td:nth-child(4) { width: 20%; min-width: 150px; } /* Title */
        .table-modern th:nth-child(5), .table-modern td:nth-child(5) { width: 12%; min-width: 120px; } /* Author */
        .table-modern th:nth-child(6), .table-modern td:nth-child(6) { width: 10%; min-width: 100px; } /* Category */
        .table-modern th:nth-child(7), .table-modern td:nth-child(7) { width: 10%; min-width: 100px; } /* Copies */
        .table-modern th:nth-child(8), .table-modern td:nth-child(8) { width: 10%; min-width: 100px; } /* Status */
        .table-modern th:nth-child(9), .table-modern td:nth-child(9) { width: 15%; min-width: 150px; } /* Action */
...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                ...
                <div class="flex-grow-1">
                    <h1 class="app-name">ADMIN</h1>
                    <p class="app-tagline">Library System</p>
                </div>
                <button class="btn btn-link d-md-none text-white p-0" id="sidebarCloseMobile" style="font-size: 24px; text-decoration: none; background: transparent; border: none; padding: 4px 8px;">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{ route('admin.libraries.index') }}" class="menu-item {{ request()->routeIs('admin.libraries.*') ? 'active' : '' }}">
                        <i class="fas fa-building"></i> <span>Libraries</span>
                    </a>
                    ...
                    <a href="{{ route('admin.borrows.index') }}" class="menu-item {{ request()->routeIs('admin.borrows.*') && !request()->routeIs('admin.borrows.overdue') ? 'active' : '' }}">
                        <i class="fas fa-exchange-alt"></i> <span>Issue/Return</span>
                    </a>
                    <a href="{{ route('admin.borrows.overdue') }}" class="menu-item {{ request()->routeIs('admin.borrows.overdue') ? 'active' : '' }}">
                ...
                <div class="menu-section">
                    ...
                    <a href="{{ route('admin.fines.index') }}" class="menu-item {{ request()->routeIs('admin.fines.*') ? 'active' : '' }}">
                        <i class="fas fa-dollar-sign"></i> <span>Fines</span>
                    </a>
                    <a href="{{ route('admin.book-requests.index') }}" class="menu-item {{ request()->routeIs('admin.book-requests.*') ? 'active' : '' }}">
                        <i class="fas fa-hand-paper"></i> <span>Book Requests</span>
                    </a>
                    <a href="{{ route('admin.library-cards.index') }}" class="menu-item {{ request()->routeIs('admin.library-cards.*') ? 'active' : '' }}">
        ...
        <div class="main-wrapper" id="main-wrapper">
            ...
            <header class="top-header">
                <div class="d-flex align-items-center gap-3">
                    <button class="navbar-toggler d-block d-md-none" type="button" id="sidebarToggleMobile" style="background: transparent; border: none; padding: 8px; font-size: 20px; color: #333; cursor: pointer;">
                        <i class="fas fa-bars"></i>
                    </button>
                    <h4 class="mb-0 fw-bold" style="font-size: 18px;">@yield('page-title', 'Dashboard')</h4>
                </div>
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        ...
                        <div class="profile-dropdown-body">
                            <a href="{{ route('admin.profile.change-password') }}" class="profile-dropdown-item">
    ...
    <script>
        ...
        function loadNotifications() {
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    $('#notificationList').html('<div class="text-center p-3 text-muted"><i class="fas fa-exclamation-triangle mb-2" style="font-size: 24px;"></i><p class="mb-0 small">Error loading notifications</p></div>');
                }
            });
        }
        ...
        // Profile dropdown toggle function - Global scope (must be outside document.ready)
        window.toggleProfileDropdown = function(e) {
            ...
            if (dropdown) {
                var isVisible = dropdown.style.display === 'block' || dropdown.classList.contains('show');
                if (isVisible) {
                    dropdown.style.display = 'none';
        ...
        $(document).ready(function() {
            ...
            $('.data-table').DataTable({
                ...
                "columnDefs": [
                    // Dynamic column widths based on table ID
                    { "width": "5%", "targets": 0, "className": "text-center" },   // # column for all tables
                ],
            ...
            $('#sidebarCloseMobile').on('click', function(e) {
                e.stopPropagation();
                closeSidebar();
            });
            ...
            // jQuery event handler as backup
            ...
            $(document).on('click', function(e) {
                var target = $(e.target);
                if (!target.closest('#profileToggle, #profileDropdown').length) {
                    var dropdown = document.getElementById('profileDropdown');
                    if (dropdown) {
                        dropdown.style.display = 'none';
                        dropdown.classList.remove('show');
