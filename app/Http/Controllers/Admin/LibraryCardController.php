...
class LibraryCardController extends Controller
{
    public function index()
    {
        ...
        return view('admin.library-cards.index', compact('cards', 'stats'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.library-cards.create', compact('students'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.library-cards.show', $card)
    ...
    public function show(LibraryCard $libraryCard)
    {
        ...
        return view('admin.library-cards.show', compact('libraryCard'));
    }
    ...
    public function block(LibraryCard $libraryCard)
    {
        ...
        $libraryCard->markAsBlocked('Blocked by admin');
    ...
    {
        $libraryCard->load('user');
        return view('admin.library-cards.print', compact('libraryCard'));
    }
}
